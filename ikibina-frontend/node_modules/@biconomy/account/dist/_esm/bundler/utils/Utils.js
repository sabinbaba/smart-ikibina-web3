 ...
 */
export const extractChainIdFromUrl = (url) => {
    try {
        const regex = /\/(\d+)\//;
 ...
 * @throws {Error} If the chain ID is not found in the URL or is invalid.
 */
export const extractChainIdFromBundlerUrl = (url) => extractChainIdFromUrl(url);
/**
 ...
 * @throws {Error} If the chain ID is not found in the URL or is invalid.
 */
export const extractChainIdFromPaymasterUrl = (url) => extractChainIdFromUrl(url);
