...
import { createBatchedSessionRouterModule, createSessionKeyManagerModule, resumeSession, } from "../index.js";
/**
 *
 ...
 *
 */
export const createSessionSmartAccountClient = async (biconomySmartAccountConfig, conditionalSession, sessionType) => {
 ...
 */
export const toSupportedSigner = (privateKey, chain) => {
 ...
 */
export const toSessionParams = (privateKey, sessionIDs, chain) => sessionIDs.map((sessionID) => ({
    sessionID,
