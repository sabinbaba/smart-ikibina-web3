import { ERROR_MESSAGES, Logger, isNullOrUndefined } from "../../account/index.js";
import { DEFAULT_BATCHED_SESSION_ROUTER_MODULE, DEFAULT_SESSION_KEY_MANAGER_MODULE, createBatchedSessionRouterModule, createSessionKeyManagerModule, didProvideFullSession, resumeSession } from "../index.js";
/**
 *
 * createBatchSession
 *
 ...
 * ```
 */
export const createBatchSession = async (smartAccount, 
...
leaves, buildUseropDto) => {
    ...
    const txs = [];
    const enableSessionKeyTx = await smartAccount.getEnableModuleData(DEFAULT_SESSION_KEY_MANAGER_MODULE);
    const enableBatchedSessionTx = await smartAccount.getEnableModuleData(DEFAULT_BATCHED_SESSION_ROUTER_MODULE);
    if (isDeployed) {
 ...
 *
 */
export const getBatchSessionTxParams = async (transactions, correspondingIndexes, conditionalSession, chain) => {
