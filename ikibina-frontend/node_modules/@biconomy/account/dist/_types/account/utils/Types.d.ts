import type { Address, Chain, Hash, Hex, PrivateKeyAccount, PublicClient, SignTypedDataParameters, SignableMessage, TypedData, TypedDataDefinition, WalletClient } from "viem";
import type { IBundler } from "../../bundler";
import type { BaseValidationModule, ModuleInfo, SessionSearchParam, SessionType } from "../../modules";
import type { ISessionStorage, SessionLeafNode } from "../../modules/interfaces/ISessionStorage";
import type { FeeQuotesOrDataDto, IPaymaster, PaymasterFeeQuote, PaymasterMode, SmartAccountData, SponsorUserOperationDto } from "../../paymaster";
...
export type BasSmartContractAccountProps = BiconomySmartAccountV2ConfigConstructorProps & {
...
export interface ISmartContractAccount<TSigner extends SmartAccountSigner = SmartAccountSigner> {
    /**
